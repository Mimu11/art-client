...
const DetailsPage = props => {
    ...
    return (
        <div className='md:flex font-Firasans lg:max-w-7xl py-20 mx-auto gap-6'>
            <div className=' w-1/2'>
                <img src={photo} alt="" className='h-screen border-8 border-orange-500' />
            </div>
            <div className='w-1/2 space-y-6 content-center'>
                <h3 className='text-5xl font-Mergrim text-red-400'>{itemName}</h3>
                ...
                <div className='flex gap-6'>
                    ...
                    <p className='text-red-500'>Email: <span className='text-red-500'>{email}</span></p>
